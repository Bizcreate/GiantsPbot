...
if (isset($update['message']['text']) && strpos($text, '/start') === 0) {
    ...
    if ($text === '/start' || $referrer_id) {
        ...
        $referralLink = $referrer_id ? "https://giantsprotocol1990.netlify.app/?ref=$referrer_id" : "https://giantsprotocol1990.netlify.app";
        ...
        if (file_exists($photoPath)) {
            ...
            $post_fields = [
                ...
                'reply_markup' => json_encode([
                    'inline_keyboard' => [
                        [
                            ['text' => 'Play giantsprotocol Now', 'web_app' => ['url' => $referralLink]],
                            ['text' => 'Join Our Community', 'url' => 'https://t.me/giantsprotocol_bot']]
                    ]
                ])
            ];
