...
<img src='/dogs.png' alt='sdfd' className='w-[10px]'/>
</div>
...
<img src='/dogs.png' alt='sdfd' className='w-[14px]'/>
                    ...
                    <div className="w-[45%] bg-cards text-[12px] rounded-[6px] p-2 text-primary flex items-center justify-center space-x-1 font-semibold text-center">
                       <span> Profit:</span> <span className='pl-1'><img src='dogs.png' alt='dfd' className='w-[10px] h-[10px] mt-[2px]'/></span> <span className='text-green-500 '>{selectedPower.capacity} PPH</span> 
                    </div>
                    </div>
