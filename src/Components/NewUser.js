  ...
  <div className='backdrop-blur-[1px] absolute top-0 left-0 right-0 bottom-0'>
    ...
    <div className='w-full flex flex-col space-y-5 items-center'>
      ...
      <h2 className='font-bold text-[30px] text-center w-full'>
        {premium ? 'You are the best' : 'Welcome to giantsprotocols'}
      </h2>
  
      <p className='text-[16px] font-semibold pb-14'>
        Here is your $giants rewards
      </p>
  
      <div className={``}>
        <img src='/stars.png' alt='sdf' className='w-[80px] premiumsvg'/>
      </div>
...
Daily Checkin
  ...
  +{formatNumber(checkinPoint)} $giants
    </p>
