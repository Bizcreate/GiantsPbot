...
const walletAddress = process.env.REACT_APP_TON_WALLET_ADDRESS;
...
<img src='/dogs.png' alt='sdfd' className='w-[15px]'/>

          <span className="text-accent">+{selectedPower.capacity} $giants</span>
              </span>
          <span>Your Purchase of {selectedPower.xx} $giants is successful</span>
        </span>
        <p className="pb-6 text-[15px] w-full text-center">
          Perform more activities or buy more $giants to stay ahead and claim listing giveaway bonues!😎
        </p>
      </div>
      );
...
<img src='/dogs.png' alt='sdfd' className='w-[70px]'/>
...
<img src='/dogs.png' alt='sdfd' className='w-[7px]'/>
</span>
</span>
...
<img src='/dogs.png' alt='sdfd' className='w-[70px]'/>
                    ...
                    <p className="pb-6 text-primary text-[14px] px-4 text-center">
                      Get {selectedPower.capacity} $giants and boost your earnings and ranks!
                    </p>
