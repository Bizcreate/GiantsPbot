...
const TonTask = () => {
  ...
  const price = 0.2
   ...
   // Fetch wallet address from environment variables
  ...
  const transaction = (cost) => ({
    ...
    messages: [
      {
        address: walletAddress, // Dynamically set wallet address
...
<img src='/dogs.png' alt='sdfd' className='w-[15px]'/>
          ...
          <span className="text-accent">+10,000 $giants CLAIMED</span>
              </span>
                ...
                <div className="flex h-full flex-1 flex-col justify-center relative">
                  <div className='flex w-full flex-col justify-between h-full space-y-1'>
                    ...
                    <span className='flex text-secondary items-center w-fit text-[15px]'>
                      ...
                      <span className=''>
                        +{formatNumber(bonusAward)} $giants
                      </span>
                    </span>
                  </div>
                </div>
